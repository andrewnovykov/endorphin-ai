...
import { z } from 'zod';
import { CustomToolErrorHandler, ToolConflictError, ToolDiscoveryError, ToolLoadError, ToolValidationError, } from './custom-tool-errors';
...
export class CustomToolDiscovery {
    ...
    extractToolFunctions(module) {
        ...
        for (const [key, value] of Object.entries(module)) {
            if (typeof value === 'function' && key.startsWith('create') && key.endsWith('Tool')) {
                functions.push({ name: key, func: value });
            }
        }
     ...
     */
    async createAndValidateTool(func, functionName, filePath) {
        // Create the tool
        let tool;
        try {
...
//# sourceMappingURL=custom-tool-discovery.js.map