...
export class DirectoryManager {
     ...
     */
    static async cleanupDirectories(resultBaseDir) {
     ...
     */
    static async cleanupRecorderDirectory(recorderBaseDir) {
     ...
     */
    static async cleanupDirectory(dirPath, description) {
     ...
     */
    static async getDirectoryFileCount(dirPath) {
        if (!existsSync(dirPath)) {
            return 0;
        }
        let count = 0;
