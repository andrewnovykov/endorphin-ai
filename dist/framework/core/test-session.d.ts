 ...
 */
export declare function createTestSession(testName: string, testId: string | null | undefined, resultBaseDir: string): TestSession;
/**
 ...
 * @returns Session summary
 */
export declare function saveTestSession(session: TestSession): SessionSummary;
export {};
