...
describe('Console Reporter', () => {
  ...
  describe('Session Management', () => {
    ...
    it('should start individual tests', () => {
      ...
      expect(mockStdout).toHaveBeenCalledWith(expect.stringContaining('TEST-001: Sample Test'));
    });
  ...
  describe('Summary Display', () => {
    it('should display summary with all passed tests', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('3 passed'));
    ...
    it('should display summary with failed tests', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('2 passed'));
  ...
  describe('Failure Details', () => {
    it('should display failure details', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('Failed Tests:'));
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('TEST-002: Test 2'));
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('Assertion failed'));
    });
  });
});
